  ...
  return (
    <div className='py-4'>
      <div className='category px-3 pb-5'>
        <NavLink to='#' className='text-md flex items-center gap-1  font-semibold'>
          <HiQueueList />
          All Category
        </NavLink>
      ...
      <div className='search-filter pb-5'>
        <NavLink to='#' className='text-md flex items-center gap-1 px-3 font-semibold'>
          <HiFunnel />
          Search filter
        </NavLink>
      </div>
      ...
      <div className='px-3 pb-5'>
        ...
        <form className=''>
          ...
          <Button className='w-full bg-orange-500 p-2 font-medium text-white'>APPLY</Button>
        </form>
      </div>
      <div className='px-3 pb-5 '>
      ...
      <div className='px-3 pb-5 '>
        <Button className='w-full bg-orange-500 p-2 font-medium text-white'>CLEAR ALL</Button>
      </div>
    </div>
  )
}
